...
__all__ = [
    'shake_resnet26_2x32d', 'shake_resnet26_2x64d', 'shake_resnet26_2x96d'
]
...
class ShakeResNet(nn.Module):
    ...
    def __init__(self,
        ...
        print(
            'INFO:PyTorch: The base width of shake-shake resnet is {}'.format(
                base_width))
        ...
        self.stage_2 = self._make_layer(n_units,
                                        in_chs[1],
                                        in_chs[2],
                                        stride=2)
        self.stage_3 = self._make_layer(n_units,
                                        in_chs[2],
                                        in_chs[3],
                                        stride=2)
