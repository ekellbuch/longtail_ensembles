...
from .resnet import BasicBlock, conv3x3, conv1x1, _resnet, Bottleneck
import os
import torch
...
class ResNetCIFAR(nn.Module):
    ...
    def __init__(
        ...
        self.layer1 = self._make_layer(block, 16, layers[0], option=option)
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False, option="A"):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:  ## why is this not triggered?
            if option == "A":
                ...
                # See https://github.com/jiawei-ren/BalancedMetaSoftmax-Classification/blob/main/models/ResNet32Feature.py
                """
...
def resnet8_cf(pretrained=False, progress=True, device="cpu", **kwargs):
    ...
    """
    return _resnet("resnet8", BasicBlockCIFAR, [1, 1, 1], pretrained, progress,
                   device, **kwargs)
...
def resnet14_cf(pretrained=False, progress=True, device="cpu", **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet14", BasicBlockCIFAR, [2, 2, 2], pretrained,
...
def resnet20_cf(pretrained=False, progress=True, device="cpu", **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet20", BasicBlockCIFAR, [3, 3, 3], pretrained,
                   progress, device, **kwargs)
...
def resnet26_cf(pretrained=False, progress=True, device="cpu", **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet26", BasicBlockCIFAR, [4, 4, 4], pretrained,
                   progress, device, **kwargs)
...
def resnet32_cf(pretrained=False, progress=True, device="cpu", **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet32", BasicBlockCIFAR, [5, 5, 5], pretrained,
                   progress, device, **kwargs)

def resnet32_cfa(pretrained=False, progress=True, device="cpu", **kwargs):
    """Constructs a ResNet-32 model (CIFAR architecture) with downsample option A.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet32", BasicBlockCIFAR, [5, 5, 5], pretrained,
                   progress, device, **kwargs, option="A")
...
def resnet38_cf(pretrained=False, progress=True, device="cpu", **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet38", BasicBlockCIFAR, [6, 6, 6], pretrained,
                   progress, device, **kwargs)
...
def resnet44_cf(pretrained=False, progress=True, device="cpu", **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet("resnet44", BasicBlockCIFAR, [7, 7, 7], pretrained,
                   progress, device, **kwargs)
